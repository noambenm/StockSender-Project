...
def lambda_handler(event, context):
        ...
        try:
            ...
            for user in subscribed_users: 
                ...
                ticker = yf.Ticker(subscribed_users['chosen_ticker'])
